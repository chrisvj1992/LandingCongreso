    ...
    <section className='bg-gray-100'>
      <div className='h-[148vh] md:h-[116vh] bg-cover bg-center custom-bg pb-96'>
        ...
        <div className=' flex flex-col items-center justify-center gap-5'>
          <h1 className=' text-4xl md:text-5xl font-bold text-center text-gray-900'>Preguntas Frecuentes</h1>
          ...
          <p className='text-lg font-semibold text-left text-gray-700'>
            - Miércoles 23 de Octubre: 8:00 am a 15:00 hrs. <br />
            - ⁠Jueves 24 de Octubre: 8:00 am a 15:00 hrs. <br />
          ...
          <p className='text-lg font-semibold text-left text-gray-700'>
          R: Estudiantes de pregrado, internos y residentes de Medicina, incluyendo distintas carreras del área de la salud como: Nutrición y Odintología/Estomatología enfocadas al aspecto quirúrgico.
          </p>
          </div>
        </div>
      </div>
      <Footer className="mt-72 md:mt-40 "/>
    </section>
  );
};
