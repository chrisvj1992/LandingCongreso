...
const Hero = () => {
    return (
    <section id="Home" className="min-h-[80vh] grid grid-cols-1 md:grid-cols-8">
        <div className="md:col-span-5 flex items-center justify-center p-12 mt-20 md:mt-5">
            <div className="flex flex-col gap-8">
                <h1 className="text-5xl md:text-7xl font-bold leading-[3.5rem] md:leading-[5.5rem]"> <span className="text-SecondaryColor">Bienvenidos</span> al 1er Congreso Nacional de Cirugia</h1>
